...
[![Build Status](https://travis-ci.org/figassis/goduck.svg?branch=master)](https://travis-ci.org/figassis/goduck)
[![codecov](https://codecov.io/gh/figassis/goduck/branch/master/graph/badge.svg)](https://codecov.io/gh/figassis/goduck)
[![Go Report Card](https://goreportcard.com/badge/github.com/figassis/goduck)](https://goreportcard.com/report/github.com/figassis/goduck)
[![Maintainability](https://api.codeclimate.com/v1/badges/c3cb09dbc0bc43186464/maintainability)](https://codeclimate.com/github/figassis/goduck/maintainability)
...
Previously Gorsk was built using [Gin](https://github.com/gin-gonic/gin). Gorsk using Gin is available [HERE](https://github.com/figassis/goduck-gin).
...
1. To use Gorsk as a starting point of a real project whose package name is something like `github.com/author/project`, move the directory `$GOPATH/github.com/figassis/goduck` to `$GOPATH/github.com/author/project`. We use [task](https://github.com/go-task/task) as a task runner. Run ``task relocate`` to rename the packages, e.g. ``task relocate TARGET=github.com/author/project``
